...
subjects = ["", "Arpit Dwivedi", "Udit Saxena", "Luke"]
...
#function to detect eyes using OpenCV
def detect_eyes(img):
    #convert the test image to gray image as opencv face detector expects gray images
    gray = cv2.cvtColor(img, cv2.COLOR_BGR2GRAY)
...
test_img3 = cv2.imread("test-data/Lucky_1.jpg")
